...
## Execução do projeto
  ...
  Nesta primeira etapa, os dados foram extraídos em formato .csv de buckets S3 sob responsabilidade da empresa, que forneceu o acesso necessário. O diagrama a seguir ilustra o processo que foi executado:
...
<img src='./docs/project_intro.png' alt='Extração e Carregamento de dados em bucket S3 na AWS'/>
  ...
  Os dados brutos foram salvos localmente incluindo a data de referência (ref) e a data_hora de processamento (proc) no nome de cada arquivo. Esta etapa foi executada com o script **data_extraction_s3_cliente.py**. Após a execução, os arquivos são salvos na pasta data:
